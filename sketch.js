...
function setup() {
  ...
  roof = new Ground(800,50,550,20);
	bob1 = new bobObj(800,600,70);
	bob2 = new bobObj(725,600,70);
	bob3 = new bobObj(650,600,70);
	bob4 = new bobObj(875,600,70);
	bob5 = new bobObj(950,600,70);
